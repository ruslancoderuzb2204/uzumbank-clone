        ...
        <div className="flex flex-col justify-center">
          <div>
            ...
            <p className="text-xl text-gray-600">
              Uzum Bank is a payment system and a reliable online bank in one{" "}
              <br />
              mobile application.
            </p>
          </div>
            ...
            <div className=" flex gap-4 mt-28">
              <div className="w-52">
                <Image
                  ...
                  height={200}
                  src={
                    "https://uzumbank.uz/_nuxt/img/en_apple_badge.8a99f76.svg"
                  }
                  alt="Apple"
                />
              </div>
              <div className="w-52">
                <Image
                  ...
                  height={50}
                  src={
                    "https://uzumbank.uz/_nuxt/img/en_google_badge.c987ead.svg"
                  }
                  alt="Google"
                />
              </div>
